...
<breadcrumb>
[D&D 5e SRD](dnd-5e-srd-toc) > [Planes](dnd-5e-srd-planes)
</breadcrumb>
...
***Spells.*** A number of spells allow direct or indirect access to other planes of existence. [*Plane shift*](dnd-5e-srd-spell-plane-shift) and [*gate*](dnd-5e-srd-spell-gate) can transport adventurers directly to any other plane of existence, with different degrees of precision. [*Etherealness*](dnd-5e-srd-spell-etherealness) allows adventurers to enter the Ethereal Plane and travel from there to any of the planes it touches—such as the Elemental Planes. And the [*astral projection*](dnd-5e-srd-spell-astral-projection) spell lets adventurers project themselves into the Astral Plane and travel to the Outer Planes.
...
The Ethereal Plane and the Astral Plane are called the Transitive Planes. They are mostly featureless realms that serve primarily as ways to travel from one plane to another. Spells such as [*etherealness*](dnd-5e-srd-spell-etherealness) and [*astral projection*](dnd-5e-srd-spell-astral-projection) allow characters to enter these planes and traverse them to reach the planes beyond.

The **Ethereal Plane** is a misty, fog-bound dimension that is sometimes described as a great ocean. Its shores, called the Border Ethereal, overlap the Material Plane and the Inner Planes, so that every location on those planes has a corresponding location on the Ethereal Plane. Certain creatures can see into the Border Ethereal, and the [*see invisibility*](dnd-5e-srd-spell-see-invisibility) and [*true seeing*](dnd-5e-srd-spell-true-seeing) spell grant that ability. Some magical effects also extend from the Material Plane into the Border Ethereal, particularly effects that use force energy such as [*forcecage*](dnd-5e-srd-spell-forcecage) and [*wall of force*](dnd-5e-srd-spell-wall-of-force). The depths of the plane, the Deep Ethereal, are a region of swirling mists and colorful fogs.
...
Demiplanes are small extradimensional spaces with their own unique rules. They are pieces of reality that don’t seem to fit anywhere else. Demiplanes come into being by a variety of means. Some are created by spells, such as [*demiplane*](dnd-5e-srd-spell-demiplane), or generated at the desire of a powerful deity or other force. They may exist naturally, as a fold of existing reality that has been pinched off from the rest of the multiverse, or as a baby universe growing in power. A given demiplane can be entered through a single point where it touches another plane. Theoretically, a [*plane shift*](dnd-5e-srd-spell-plane-shift) spell can also carry travelers to a demiplane, but the proper frequency required for the tuning fork is extremely hard to acquire. The [*gate*](dnd-5e-srd-spell-gate) spell is more reliable, assuming the caster knows of the demiplane.
